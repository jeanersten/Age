...
function build_debug() {
    ...
    log "${COLOR_GREEN}Debug build succeeded. Executable created at $TARGET_DEBUG.${COLOR_RESET}"
}
...
function build_release() {
    ...
    log "${COLOR_GREEN}Release build succeeded. Executable created at $TARGET_RELEASE.${COLOR_RESET}"
}
